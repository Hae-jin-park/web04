<%@page import="com.study.vo.MemberVO"%>
...
<%
 ...
 %>
<%-- <div style="background-color:#00408b;color:#ffffff;padding:5px;">
Simple Web Based FTM
<c:if test="${!empty sessionScope.member and 
              !empty sessionScope.member.id}">
<span style="float:right">
${sessionScope.member.name }
<a href="${pageContext.request.contextPath }/authentication/logoff.do">로그아웃</a>
</span>
</c:if>
</div> --%>
